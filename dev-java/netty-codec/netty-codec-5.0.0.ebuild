...
# com.ning:compress-lzf:1.0.1 -> >=app-maven/compress-lzf-1.0.4:0
# io.netty:netty-transport:5.0.0.Alpha2 -> >=dev-java/netty-transport-5.0.0:0
# net.jpountz.lz4:lz4:1.2.0 -> >=app-maven/lz4-1.3:0
...
JAVA_GENTOO_CLASSPATH="lzma-java,protobuf-java,jzlib-1.1,compress-lzf,netty-transport,lz4,jboss-marshalling"
