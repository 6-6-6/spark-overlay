...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/hadoop-yarn-server-web-proxy-2.10.1.pom --from-maven-central --download-uri https://repo1.maven.org/maven2/org/apache/hadoop/hadoop-yarn-server-web-proxy/2.10.1/hadoop-yarn-server-web-proxy-2.10.1-sources.jar --binjar-uri https://repo1.maven.org/maven2/org/apache/hadoop/hadoop-yarn-server-web-proxy/2.10.1/hadoop-yarn-server-web-proxy-2.10.1.jar --slot 0 --keywords "~amd64" --ebuild hadoop-yarn-server-web-proxy-2.10.1.ebuild

EAPI=7

JAVA_PKG_IUSE="doc source test binary"
MAVEN_ID="org.apache.hadoop:hadoop-yarn-server-web-proxy:2.10.1"
...
JAVA_GENTOO_CLASSPATH="guava-20,commons-logging,servlet-api-4.0,hadoop-yarn-api,hadoop-yarn-common,hadoop-yarn-server-common,jetty-6"
