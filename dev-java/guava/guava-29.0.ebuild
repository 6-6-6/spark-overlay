...
SRC_URI="https://repo.maven.apache.org/maven2/com/google/${PN}/${PN}/${PV}-jre/${P}-jre-sources.jar"
LICENSE=""
SLOT="0"
KEYWORDS="~amd64"
...
# com.google.errorprone:error_prone_annotations:2.3.4 -> >=dev-java/error-2.4.0:prone_annotations
...
# com.google.j2objc:j2objc-annotations:1.3 -> >=app-maven/j2objc-annotations-1.3:0
# org.checkerframework:checker-qual:2.11.1 -> >=app-maven/checker-qual-3.4.1:0

CDEPEND="
	>=app-maven/checker-qual-3.4.1:0
	>=app-maven/failureaccess-1.0.1:0
	>=app-maven/j2objc-annotations-1.3:0
	>=app-maven/listenablefuture-9999.0.:0
	>=dev-java/error-2.4.0:prone_annotations
