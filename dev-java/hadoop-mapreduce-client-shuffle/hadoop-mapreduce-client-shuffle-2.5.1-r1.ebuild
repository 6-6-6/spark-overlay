...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/hadoop-mapreduce-client-shuffle-2.5.1.pom --download-uri https://repo1.maven.org/maven2/org/apache/hadoop/hadoop-mapreduce-client-shuffle/2.5.1/hadoop-mapreduce-client-shuffle-2.5.1-sources.jar --slot 0 --keywords "~amd64" --ebuild hadoop-mapreduce-client-shuffle-2.5.1-r1.ebuild
...
# org.apache.hadoop:hadoop-yarn-server-nodemanager:2.5.1 -> >=dev-java/hadoop-yarn-server-nodemanager-2.5.1:0
...
CDEPEND="
	...
	>=dev-java/hadoop-yarn-server-nodemanager-2.5.1:0
