...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/hadoop-mapreduce-client-shuffle-2.7.4.pom --download-uri https://repo1.maven.org/maven2/org/apache/hadoop/hadoop-mapreduce-client-shuffle/2.7.4/hadoop-mapreduce-client-shuffle-2.7.4-sources.jar --slot 0 --keywords "~amd64" --ebuild hadoop-mapreduce-client-shuffle-2.7.4-r1.ebuild

EAPI=7

JAVA_PKG_IUSE="doc source test binary"
MAVEN_ID="org.apache.hadoop:hadoop-mapreduce-client-shuffle:2.7.4"
...
# org.apache.hadoop:hadoop-mapreduce-client-common:2.7.4 -> >=dev-java/hadoop-mapreduce-client-common-2.7.4:0
# org.apache.hadoop:hadoop-yarn-server-common:2.7.4 -> >=dev-java/hadoop-yarn-server-common-2.7.4:0
# org.apache.hadoop:hadoop-yarn-server-nodemanager:2.7.4 -> >=dev-java/hadoop-yarn-server-nodemanager-2.7.4:0
...
CDEPEND="
	...
	>=dev-java/hadoop-yarn-server-nodemanager-2.7.4:0
