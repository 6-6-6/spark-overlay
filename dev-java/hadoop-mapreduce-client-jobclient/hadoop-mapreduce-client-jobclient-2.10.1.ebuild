...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/hadoop-mapreduce-client-jobclient-2.10.1.pom --from-maven-central --download-uri https://repo1.maven.org/maven2/org/apache/hadoop/hadoop-mapreduce-client-jobclient/2.10.1/hadoop-mapreduce-client-jobclient-2.10.1-sources.jar --binjar-uri https://repo1.maven.org/maven2/org/apache/hadoop/hadoop-mapreduce-client-jobclient/2.10.1/hadoop-mapreduce-client-jobclient-2.10.1.jar --slot 0 --keywords "~amd64" --ebuild hadoop-mapreduce-client-jobclient-2.10.1.ebuild

EAPI=7

JAVA_PKG_IUSE="doc source test binary"
MAVEN_ID="org.apache.hadoop:hadoop-mapreduce-client-jobclient:2.10.1"
...
JAVA_GENTOO_CLASSPATH="guice-servlet,protobuf-java,netty,avro,hadoop-annotations,hadoop-mapreduce-client-common,hadoop-mapreduce-client-shuffle,slf4j-api,slf4j-log4j12"
