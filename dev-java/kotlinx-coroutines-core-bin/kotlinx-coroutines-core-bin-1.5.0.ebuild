...
MAVEN_PROVIDES="
	org.jetbrains.kotlinx:kotlinx-coroutines-core:${PV}
	org.jetbrains.kotlinx:kotlinx-coroutines-core-jvm:${PV}
"

inherit java-pkg-2 java-pkg-simple

MY_PN="kotlinx-coroutines-core-jvm"
MY_P="${MY_PN}-${PV}"
