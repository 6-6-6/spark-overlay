...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/log4j-api-2.3.pom --download-uri https://repo1.maven.org/maven2/org/apache/logging/log4j/log4j-api/2.3/log4j-api-2.3-sources.jar --slot 0 --keywords "~amd64" --ebuild log4j-api-2.3-r1.ebuild
