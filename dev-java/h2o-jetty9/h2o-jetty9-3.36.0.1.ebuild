...
# Bundled class originally from Jetty 9 included and should be removed,
# which makes the produced JAR's content differ from the pre-built one
RESTRICT="test"
...
JAVA_RM_FILES=(
	# Removed bundled class from Jetty
	"${JAVA_SRC_DIR}/org/eclipse/jetty/server/Response.java"
)
