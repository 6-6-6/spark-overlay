...
# com.thoughtworks.xstream:xstream:1.4.2 -> >=dev-java/xstream-1.4.2:0
...
# org.apache.ant:ant-launcher:1.8.4 -> >=dev-java/ant-launcher-1.8.4:0
# org.codehaus.gpars:gpars:1.0.0 -> >=dev-java/gpars-1.0.0:0
...
JAVA_CLASSPATH_EXTRA="jsp-2.3,servlet-api-4.0"
