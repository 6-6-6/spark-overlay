...
MAVEN_ID="ai.h2o:h2o-jetty-9-minimal:${PV}"
...
MY_PN="h2o-jetty-9-minimal"
MY_P="${MY_PN}-${PV}"

DESCRIPTION="H2O Jetty 9 Minimal"
...
CP_DEPEND="
	...
	>=dev-java/jetty-server-9.4.44_p20210927:9
	>=dev-java/jetty-servlet-9.4.44_p20210927:9
"
