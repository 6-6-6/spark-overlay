...
# org.apache.lucene:lucene-queries:7.6.0 -> >=dev-java/lucene-queries-7.6.0:0
# org.apache.lucene:lucene-sandbox:7.6.0 -> >=dev-java/lucene-sandbox-7.6.0:0

CDEPEND="
	>=dev-java/lucene-queries-7.6.0:0
	>=dev-java/lucene-sandbox-7.6.0:0
