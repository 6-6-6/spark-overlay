...
SRC_URI="https://repo.maven.apache.org/maven2/org/eclipse/jetty/npn/${MY_PN}/8.1.2.v20120308/${MY_PN}-8.1.2.v20120308-sources.jar"
LICENSE=""
SLOT="0"
KEYWORDS="~amd64"
MAVEN_ID="org.eclipse.jetty.npn:npn-api:8.1.2.v20120308"
