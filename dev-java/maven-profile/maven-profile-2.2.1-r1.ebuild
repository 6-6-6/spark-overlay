...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/maven-profile-2.2.1.pom --download-uri https://repo1.maven.org/maven2/org/apache/maven/maven-profile/2.2.1/maven-profile-2.2.1-sources.jar --slot 0 --keywords "~amd64" --ebuild maven-profile-2.2.1-r1.ebuild
