...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/graal-sdk-19.2.1.pom --download-uri https://repo1.maven.org/maven2/org/graalvm/sdk/graal-sdk/19.2.1/graal-sdk-19.2.1-sources.jar --slot 0 --keywords "~amd64" --ebuild graal-sdk-19.2.1-r1.ebuild
