...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/netty-resolver-dns-5.0.0.Alpha2.pom --download-uri https://repo1.maven.org/maven2/io/netty/netty-resolver-dns/5.0.0.Alpha2/netty-resolver-dns-5.0.0.Alpha2-sources.jar --slot 0 --keywords "~amd64" --ebuild netty-resolver-dns-5.0.0-r1.ebuild
...
# io.netty:netty-codec-dns:5.0.0.Alpha2 -> >=dev-java/netty-codec-dns-5.0.0:0
