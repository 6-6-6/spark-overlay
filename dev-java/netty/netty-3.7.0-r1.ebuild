...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/netty-3.7.0.Final.pom --download-uri https://repo1.maven.org/maven2/io/netty/netty/3.7.0.Final/netty-3.7.0.Final-sources.jar --slot 0 --keywords "~amd64" --ebuild netty-3.7.0-r1.ebuild

EAPI=7

JAVA_PKG_IUSE="doc source test binary"
MAVEN_ID="io.netty:netty:3.7.0.Final"
...
# org.jboss.logging:jboss-logging-spi:2.1.2.GA -> >=dev-java/jboss-logging-spi-2.1.2:0
...
JAVA_GENTOO_CLASSPATH="protobuf-java,commons-logging,javax-activation,servlet-api-4.0,log4j,osgi-compendium,osgi-core-1,jboss-logging-spi,jboss-marshalling,slf4j-api,tomcat-jni"
