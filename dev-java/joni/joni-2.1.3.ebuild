...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/joni-2.1.3.pom --download-uri https://repo.maven.apache.org/maven2/org/jruby/joni/joni/2.1.3/joni-2.1.3-sources.jar --slot 0 --keywords "~amd64" --ebuild joni-2.1.3.ebuild
