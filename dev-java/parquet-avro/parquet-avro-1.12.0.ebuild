...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/parquet-avro-1.12.0.pom --from-maven-central --download-uri https://repo1.maven.org/maven2/org/apache/parquet/parquet-avro/1.12.0/parquet-avro-1.12.0-sources.jar --binjar-uri https://repo1.maven.org/maven2/org/apache/parquet/parquet-avro/1.12.0/parquet-avro-1.12.0.jar --slot 0 --keywords "~amd64" --ebuild parquet-avro-1.12.0.ebuild

EAPI=7

JAVA_PKG_IUSE="doc source test binary"
MAVEN_ID="org.apache.parquet:parquet-avro:1.12.0"
...
# org.apache.avro:avro:1.10.1 -> >=dev-java/avro-1.10.1:0
...
# org.apache.parquet:parquet-hadoop:1.12.0 -> >=dev-java/parquet-hadoop-1.12.0:0

CDEPEND="
	>=dev-java/avro-1.10.1:0
	>=dev-java/parquet-column-1.12.0:0
	>=dev-java/parquet-format-structures-1.12.0:0
	>=dev-java/parquet-hadoop-1.12.0:0
"
...
JAVA_GENTOO_CLASSPATH="avro,parquet-column,parquet-format-structures,parquet-hadoop"
