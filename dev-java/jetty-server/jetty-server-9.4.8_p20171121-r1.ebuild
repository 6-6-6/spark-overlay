...
SRC_URI="
	https://repo1.maven.org/maven2/org/eclipse/jetty/${PN}/9.4.8.v20171121/${PN}-9.4.8.v20171121-sources.jar -> ${P}-sources.jar
...
JAVA_GENTOO_CLASSPATH="servlet-api-3.1,jetty-http-9,jetty-io-9,jetty-jmx-9"
