...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/janino-3.1.2.pom --download-uri https://repo.maven.apache.org/maven2/org/codehaus/janino/janino/3.1.2/janino-3.1.2-sources.jar --slot 0 --keywords "~amd64" --ebuild janino-3.1.2.ebuild
...
SLOT="0"
KEYWORDS="~amd64"
MAVEN_ID="org.codehaus.janino:janino:3.1.2"
