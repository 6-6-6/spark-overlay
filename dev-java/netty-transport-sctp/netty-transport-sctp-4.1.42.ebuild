...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/netty-transport-sctp-4.1.42.Final.pom --from-maven-central --download-uri https://repo1.maven.org/maven2/io/netty/netty-transport-sctp/4.1.42.Final/netty-transport-sctp-4.1.42.Final-sources.jar --binjar-uri https://repo1.maven.org/maven2/io/netty/netty-transport-sctp/4.1.42.Final/netty-transport-sctp-4.1.42.Final.jar --slot 0 --keywords "~amd64" --ebuild netty-transport-sctp-4.1.42.ebuild
...
MAVEN_ID="io.netty:netty-transport-sctp:4.1.42.Final"
