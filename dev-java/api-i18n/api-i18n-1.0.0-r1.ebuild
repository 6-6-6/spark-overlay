...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/api-i18n-1.0.0-M20.pom --download-uri https://repo1.maven.org/maven2/org/apache/directory/api/api-i18n/1.0.0-M20/api-i18n-1.0.0-M20-sources.jar --slot 0 --keywords "~amd64" --ebuild api-i18n-1.0.0-r1.ebuild
