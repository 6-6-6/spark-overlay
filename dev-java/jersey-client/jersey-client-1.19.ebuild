...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/jersey-client-1.19.pom --from-maven-central --download-uri https://repo1.maven.org/maven2/com/sun/jersey/jersey-client/1.19/jersey-client-1.19-sources.jar --binjar-uri https://repo1.maven.org/maven2/com/sun/jersey/jersey-client/1.19/jersey-client-1.19.jar --slot 0 --keywords "~amd64" --ebuild jersey-client-1.19.ebuild

EAPI=7

JAVA_PKG_IUSE="doc source test binary"
MAVEN_ID="com.sun.jersey:jersey-client:1.19"
