...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/hadoop-yarn-server-nodemanager-2.10.1.pom --from-maven-central --download-uri https://repo1.maven.org/maven2/org/apache/hadoop/hadoop-yarn-server-nodemanager/2.10.1/hadoop-yarn-server-nodemanager-2.10.1-sources.jar --binjar-uri https://repo1.maven.org/maven2/org/apache/hadoop/hadoop-yarn-server-nodemanager/2.10.1/hadoop-yarn-server-nodemanager-2.10.1.jar --slot 0 --keywords "~amd64" --ebuild hadoop-yarn-server-nodemanager-2.10.1.ebuild

EAPI=7

JAVA_PKG_IUSE="doc source test binary"
MAVEN_ID="org.apache.hadoop:hadoop-yarn-server-nodemanager:2.10.1"
...
# com.codahale.metrics:metrics-core:3.0.1 -> >=dev-java/metrics-core-3.0.1:0
...
JAVA_GENTOO_CLASSPATH="metrics-core,guava-20,guice-4,guice-servlet,protobuf-java,jersey-client-1,jersey-core-1,jersey-json-1,jersey-guice-1,commons-codec,commons-lang-2.1,commons-logging,servlet-api-4.0,jaxb-api,hadoop-annotations,hadoop-yarn-api,hadoop-yarn-common,hadoop-yarn-registry,hadoop-yarn-server-common,jettison,leveldbjni,jetty-util-6,slf4j-api"
