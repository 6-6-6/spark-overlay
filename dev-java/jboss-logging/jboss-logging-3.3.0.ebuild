...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/jboss-logging-3.3.0.Final.pom --download-uri https://repo.maven.apache.org/maven2/org/jboss/logging/jboss-logging/3.3.0.Final/jboss-logging-3.3.0.Final-sources.jar --slot 0 --keywords "~amd64" --ebuild jboss-logging-3.3.0.ebuild
...
SLOT="0"
KEYWORDS="~amd64"
MAVEN_ID="org.jboss.logging:jboss-logging:3.3.0.Final"


# Compile dependencies
# POM: /var/lib/java-ebuilder/poms/${P}.Final.pom
# log4j:log4j:1.2.16 -> >=dev-java/log4j-1.2.17:0
# org.apache.logging.log4j:log4j-api:2.0 -> >=app-maven/log4j-api-2.3:0
