...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/jboss-logging-3.4.1.Final.pom --download-uri https://repo.maven.apache.org/maven2/org/jboss/logging/jboss-logging/3.4.1.Final/jboss-logging-3.4.1.Final-sources.jar --slot 0 --keywords "~amd64" --ebuild jboss-logging-3.4.1.ebuild
...
SLOT="0"
KEYWORDS="~amd64"
MAVEN_ID="org.jboss.logging:jboss-logging:3.4.1.Final"
...
DEPEND="
	...
	>=dev-java/jboss-logmanager-2.3.0:0
