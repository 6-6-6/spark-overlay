...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /tmp/java-ebuilder/poms/websocket-server-9.4.11.v20180605.pom --from-maven-central --download-uri https://repo1.maven.org/maven2/org/eclipse/jetty/websocket/websocket-server/9.4.11.v20180605/websocket-server-9.4.11.v20180605-sources.jar --binjar-uri https://repo1.maven.org/maven2/org/eclipse/jetty/websocket/websocket-server/9.4.11.v20180605/websocket-server-9.4.11.v20180605.jar --slot 9 --keywords "~amd64" --ebuild websocket-server-9.4.11_p20180605.ebuild

EAPI=7

JAVA_PKG_IUSE="doc source test binary"
MAVEN_ID="org.eclipse.jetty.websocket:websocket-server:9.4.11.v20180605"
...
# org.eclipse.jetty.websocket:websocket-client:9.4.11.v20180605 -> ~dev-java/websocket-client-9.4.11_p20180605:9
# org.eclipse.jetty.websocket:websocket-common:9.4.11.v20180605 -> ~dev-java/websocket-common-9.4.11_p20180605:9
# org.eclipse.jetty.websocket:websocket-servlet:9.4.11.v20180605 -> ~dev-java/websocket-servlet-9.4.11_p20180605:9
...
# org.eclipse.jetty:jetty-server:9.4.11.v20180605 -> ~dev-java/jetty-server-9.4.11_p20180605:9
