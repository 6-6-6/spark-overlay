...
public abstract class AbstractCAL10NBundleFinder implements CAL10NBundleFinder {
  ...
  public CAL10NBundle getBundle(String baseName, Locale locale, String charset) {
    ...
    System.out.print("languageAndCountryCandidate: ");
    System.out.println(languageAndCountryCandidate);
    System.out.print("languageOnlyCandidate: ");
    System.out.println(languageOnlyCandidate);
