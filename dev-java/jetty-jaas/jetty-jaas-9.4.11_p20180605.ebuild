...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /tmp/java-ebuilder/poms/jetty-jaas-9.4.11.v20180605.pom --from-maven-central --download-uri https://repo1.maven.org/maven2/org/eclipse/jetty/jetty-jaas/9.4.11.v20180605/jetty-jaas-9.4.11.v20180605-sources.jar --binjar-uri https://repo1.maven.org/maven2/org/eclipse/jetty/jetty-jaas/9.4.11.v20180605/jetty-jaas-9.4.11.v20180605.jar --slot 9 --keywords "~amd64" --ebuild jetty-jaas-9.4.11_p20180605.ebuild

EAPI=7

JAVA_PKG_IUSE="doc source test binary"
MAVEN_ID="org.eclipse.jetty:jetty-jaas:9.4.11.v20180605"
