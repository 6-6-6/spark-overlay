...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/hadoop-yarn-client-2.10.1.pom --from-maven-central --download-uri https://repo1.maven.org/maven2/org/apache/hadoop/hadoop-yarn-client/2.10.1/hadoop-yarn-client-2.10.1-sources.jar --binjar-uri https://repo1.maven.org/maven2/org/apache/hadoop/hadoop-yarn-client/2.10.1/hadoop-yarn-client-2.10.1.jar --slot 0 --keywords "~amd64" --ebuild hadoop-yarn-client-2.10.1.ebuild

EAPI=7

JAVA_PKG_IUSE="doc source test binary"
MAVEN_ID="org.apache.hadoop:hadoop-yarn-client:2.10.1"
...
JAVA_GENTOO_CLASSPATH="guava-20,commons-cli-1,commons-lang-2.1,commons-logging,log4j,hadoop-annotations,hadoop-yarn-api,hadoop-yarn-common"
