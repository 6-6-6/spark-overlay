...
run_test() {
    ...
    find /var/db/repos/spark-overlay -type d -name 'kotlin-core-*' -fprintf core-pkgs '%P:1.4\n'
    xargs -a core-pkgs emerge -1 dev-java/kotlin-stdlib{,-js}:1.4 dev-java/kotlin-reflect:1.4
