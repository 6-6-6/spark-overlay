...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/pointsto-19.2.1.pom --download-uri https://repo1.maven.org/maven2/com/oracle/substratevm/pointsto/19.2.1/pointsto-19.2.1-sources.jar --slot 0 --keywords "~amd64" --ebuild pointsto-19.2.1.ebuild
