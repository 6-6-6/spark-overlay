...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/zookeeper-3.4.14.pom --download-uri https://repo1.maven.org/maven2/org/apache/zookeeper/zookeeper/3.4.14/zookeeper-3.4.14-sources.jar --slot 0 --keywords "~amd64" --ebuild zookeeper-3.4.14.ebuild
