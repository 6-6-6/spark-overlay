...
SRC_URI="https://repo1.maven.org/maven2/jakarta/activation/jakarta.activation-api/${PV}-RC3/jakarta.activation-api-${PV}-RC3-sources.jar -> ${P}.jar
...
src_unpack() {
	...
	rm ${S}/${JAVA_SRC_DIR}/module-info.java
}
