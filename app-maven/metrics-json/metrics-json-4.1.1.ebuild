...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/metrics-json-4.1.1.pom --download-uri https://repo.maven.apache.org/maven2/io/dropwizard/metrics/metrics-json/4.1.1/metrics-json-4.1.1-sources.jar --slot 0 --keywords "~amd64" --ebuild metrics-json-4.1.1.ebuild
...
# com.fasterxml.jackson.core:jackson-databind:2.9.9.3 -> >=dev-java/jackson-databind-2.11.0:2
