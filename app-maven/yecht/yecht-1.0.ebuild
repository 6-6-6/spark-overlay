...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/yecht-1.0.pom --download-uri https://repo.maven.apache.org/maven2/org/jruby/yecht/1.0/yecht-1.0-sources.jar --slot 0 --keywords "~amd64" --ebuild yecht-1.0.ebuild
