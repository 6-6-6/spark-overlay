...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/reactor-core-3.1.4.RELEASE.pom --download-uri https://repo1.maven.org/maven2/io/projectreactor/reactor-core/3.1.4.RELEASE/reactor-core-3.1.4.RELEASE-sources.jar --slot 0 --keywords "~amd64" --ebuild reactor-core-3.1.4.ebuild
...
SRC_URI="https://repo1.maven.org/maven2/io/projectreactor/${PN}/${PV}.RELEASE/${P}.RELEASE-sources.jar -> ${P}.jar
