...
# org.osgi:org.osgi.core:4.3.0 -> >=app-maven/osgi-core-6.0.0:6
# org.slf4j:slf4j-api:1.6.5 -> >=dev-java/slf4j-simple-1.7.7:0
...
JAVA_GENTOO_CLASSPATH="protobuf-java,commons-logging,netty-example,netty-metrics-yammer,log4j,jboss-logging-spi,jboss-marshalling,org-osgi-compendium,osgi-core-6,slf4j-simple"
