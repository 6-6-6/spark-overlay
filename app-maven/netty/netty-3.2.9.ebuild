...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/netty-3.2.9.Final.pom --download-uri https://repo.maven.apache.org/maven2/org/jboss/netty/netty/3.2.9.Final/netty-3.2.9.Final-sources.jar --slot 0 --keywords "~amd64" --ebuild netty-3.2.9.ebuild
...
SRC_URI="https://repo.maven.apache.org/maven2/org/jboss/${PN}/${PN}/${PV}.Final/${P}.Final-sources.jar -> ${P}.jar"
LICENSE=""
SLOT="0"
KEYWORDS="~amd64"
...
JAVA_GENTOO_CLASSPATH="protobuf-java,commons-logging,servlet-api-4.0,log4j,org-osgi-compendium,osgi-core-1,jboss-logging-spi,slf4j-api"
