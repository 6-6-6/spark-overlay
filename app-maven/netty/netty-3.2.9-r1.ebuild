...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/netty-3.2.9.Final.pom --download-uri https://repo1.maven.org/maven2/org/jboss/netty/netty/3.2.9.Final/netty-3.2.9.Final-sources.jar --slot 0 --keywords "~amd64" --ebuild netty-3.2.9-r1.ebuild
