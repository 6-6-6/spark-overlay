...
SRC_URI="https://repo.maven.apache.org/maven2/io/${PN}/${PN}/${PV}.Final/${P}.Final-sources.jar"
LICENSE=""
SLOT="0"
KEYWORDS="~amd64"
...
# org.jboss.logging:jboss-logging:3.1.4.GA -> >=dev-java/jboss-logging-3.4.1:0
...
JAVA_GENTOO_CLASSPATH="protobuf-java,commons-logging,netty-tcnative,activation,servlet-api-2.5,log4j,org-osgi-compendium,osgi-core-1,bcpkix-1.50,jetty-npn-api,jboss-logging,jboss-marshalling,slf4j-ext"
