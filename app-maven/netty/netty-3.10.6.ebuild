...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/netty-3.10.6.Final.pom --download-uri https://repo.maven.apache.org/maven2/io/netty/netty/3.10.6.Final/netty-3.10.6.Final-sources.jar --slot 0 --keywords "~amd64" --ebuild netty-3.10.6.ebuild
...
SRC_URI="https://repo.maven.apache.org/maven2/io/${PN}/${PN}/${PV}.Final/${P}.Final-sources.jar -> ${P}.jar"
LICENSE=""
SLOT="0"
KEYWORDS="~amd64"
...
# io.netty:netty-tcnative:1.1.30.Fork2 -> >=app-maven/netty-tcnative-1.1.32:0
...
# org.jboss.logging:jboss-logging:3.1.4.GA -> >=dev-java/jboss-logging-3.3.0:0
...
JAVA_GENTOO_CLASSPATH="protobuf-java,commons-logging,netty-tcnative,activation,servlet-api-4.0,log4j,org-osgi-compendium,osgi-core-1,bcpkix-1.50,jetty-npn-api,jboss-logging,jboss-marshalling,slf4j-api"
