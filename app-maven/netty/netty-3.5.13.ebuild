...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/netty-3.5.13.Final.pom --download-uri https://repo1.maven.org/maven2/io/netty/netty/3.5.13.Final/netty-3.5.13.Final-sources.jar --slot 0 --keywords "~amd64" --ebuild netty-3.5.13.ebuild
