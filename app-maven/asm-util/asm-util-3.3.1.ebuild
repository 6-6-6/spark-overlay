...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/asm-util-3.3.1.pom --download-uri https://repo.maven.apache.org/maven2/asm/asm-util/3.3.1/asm-util-3.3.1.jar --slot 0 --keywords "~amd64" --ebuild asm-util-3.3.1.ebuild
