...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/jboss-logging-processor-2.2.1.Final.pom --download-uri https://repo.maven.apache.org/maven2/org/jboss/logging/jboss-logging-processor/2.2.1.Final/jboss-logging-processor-2.2.1.Final-sources.jar --slot 0 --keywords "~amd64" --ebuild jboss-logging-processor-2.2.1.ebuild
...
SLOT="0"
KEYWORDS="~amd64"
MAVEN_ID="org.jboss.logging:jboss-logging-processor:2.2.1.Final"

# Common dependencies
# POM: /var/lib/java-ebuilder/poms/${P}.Final.pom
# org.jboss.jdeparser:jdeparser:2.0.3.Final -> >=app-maven/jdeparser-2.0.3:0
# org.jboss.logging:jboss-logging-annotations:2.2.1.Final -> >=app-maven/jboss-logging-annotations-2.2.1:0
