...
# xmlpull:xmlpull:1.1.3.1 -> >=app-maven/xmlpull-bin-1.1.3.4:0
# xom:xom:1.1 -> >=dev-java/xom-1.3.2:0
...
CDEPEND="
	...
	>=app-maven/xmlpull-bin-1.1.3.4:0
...
JAVA_GENTOO_CLASSPATH="cglib-3,dom4j-1,activation,joda-time,kxml2-min,jettison,wstx-asl,jdom,jdom-2,stax-api,stax-api,xmlpull-bin,xom,xpp3"
JAVA_GENTOO_CLASSPATH_EXTRA="jaxb-api"
