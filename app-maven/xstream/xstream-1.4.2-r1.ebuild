...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/xstream-1.4.2.pom --download-uri https://repo1.maven.org/maven2/com/thoughtworks/xstream/xstream/1.4.2/xstream-1.4.2-sources.jar --slot 0 --keywords "~amd64" --ebuild xstream-1.4.2-r1.ebuild
...
JAVA_GENTOO_CLASSPATH="cglib-3,dom4j-1,joda-time,kxml-2,kxml-2,jettison,wstx-3.2,jdom,json,stax,stax,xmlpull,xom,xpp3"
