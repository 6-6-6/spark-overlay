...
JAVA_GENTOO_CLASSPATH="jackson-2,jackson-databind,jackson-jaxrs-json-provider,jackson-module-jaxb-annotations,guava-20,guice-4,guice-4,protobuf-java,jersey-client,jersey-core,jersey-json,jersey-server,jersey-guice,commons-cli-1,commons-codec,commons-io-1,commons-logging,servlet-api-2.3,jaxb-api,log4j,commons-compress,hadoop-annotations,hadoop-auth,hadoop-hdfs-client,hadoop-yarn-api,jetty-util,slf4j-api"
