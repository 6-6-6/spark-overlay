...
JAVA_GENTOO_CLASSPATH="guava,guice-4,guice-4,protobuf-java,jersey-core,jersey-json,jersey-server,jersey-guice,commons-cli-1,commons-codec,commons-io-1,commons-lang-2.1,commons-logging,servlet-4.0,jaxb-api,log4j,commons-compress,hadoop-annotations,hadoop-yarn-api,jackson-core-asl,jackson-jaxrs,jackson-mapper-asl,jackson-xc,slf4j-api"
