...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/serpent-1.30.pom --download-uri https://repo.maven.apache.org/maven2/net/razorvine/serpent/1.30/serpent-1.30-sources.jar --slot 0 --keywords "~amd64" --ebuild serpent-1.30.ebuild
...
SLOT="0"
KEYWORDS="~amd64"
MAVEN_ID="net.razorvine:serpent:1.30"
