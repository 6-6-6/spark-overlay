...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/serpent-1.23.pom --download-uri https://repo.maven.apache.org/maven2/net/razorvine/serpent/1.23/serpent-1.23-sources.jar --slot 0 --keywords "~amd64" --ebuild serpent-1.23.ebuild
