...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/wagon-file-1.0-beta-6.pom --download-uri https://repo1.maven.org/maven2/org/apache/maven/wagon/wagon-file/1.0-beta-6/wagon-file-1.0-beta-6-sources.jar --slot 0 --keywords "~amd64" --ebuild wagon-file-1.0_beta6.ebuild
