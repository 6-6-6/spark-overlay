...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/archaius-core-0.4.1.pom --download-uri https://repo1.maven.org/maven2/com/netflix/archaius/archaius-core/0.4.1/archaius-core-0.4.1-sources.jar --slot 0 --keywords "~amd64" --ebuild archaius-core-0.4.1.ebuild
...
SRC_URI="https://repo1.maven.org/maven2/com/netflix/archaius/${PN}/${PV}/${P}-sources.jar -> ${P}.jar
