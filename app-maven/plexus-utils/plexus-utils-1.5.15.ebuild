...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/plexus-utils-1.5.15.pom --download-uri https://repo1.maven.org/maven2/org/codehaus/plexus/plexus-utils/1.5.15/plexus-utils-1.5.15-sources.jar --slot 0 --keywords "~amd64" --ebuild plexus-utils-1.5.15.ebuild
