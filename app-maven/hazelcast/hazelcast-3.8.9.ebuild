...
# org.jruby:jruby-complete:1.7.22 -> >=dev-java/jruby-9.1.17.0:0
...
JAVA_CLASSPATH_EXTRA="findbugs-annotation-3,cache-api,log4j,log4j-api,log4j-core,groovy-all,jruby,osgi-core-6,slf4j-ext"
