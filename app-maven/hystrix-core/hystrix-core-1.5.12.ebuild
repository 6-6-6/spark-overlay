...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/hystrix-core-1.5.12.pom --download-uri https://repo1.maven.org/maven2/com/netflix/hystrix/hystrix-core/1.5.12/hystrix-core-1.5.12-sources.jar --slot 0 --keywords "~amd64" --ebuild hystrix-core-1.5.12.ebuild
...
SRC_URI="https://repo1.maven.org/maven2/com/netflix/hystrix/${PN}/${PV}/${P}-sources.jar -> ${P}.jar
