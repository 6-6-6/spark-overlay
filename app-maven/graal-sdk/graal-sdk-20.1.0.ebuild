...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/graal-sdk-20.1.0.pom --download-uri https://repo.maven.apache.org/maven2/org/graalvm/sdk/graal-sdk/20.1.0/graal-sdk-20.1.0-sources.jar --slot 0 --keywords "~amd64" --ebuild graal-sdk-20.1.0.ebuild
