...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/lucene-queryparser-7.6.0.pom --download-uri https://repo1.maven.org/maven2/org/apache/lucene/lucene-queryparser/7.6.0/lucene-queryparser-7.6.0-sources.jar --slot 0 --keywords "~amd64" --ebuild lucene-queryparser-7.6.0.ebuild
