...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/lucene-queryparser-3.6.2.pom --download-uri https://repo1.maven.org/maven2/org/apache/lucene/lucene-queryparser/3.6.2/lucene-queryparser-3.6.2-sources.jar --slot 3.6 --keywords "~amd64" --ebuild lucene-queryparser-3.6.2.ebuild
