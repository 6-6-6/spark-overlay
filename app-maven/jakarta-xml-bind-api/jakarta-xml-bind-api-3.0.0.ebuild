...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/jakarta.xml.bind-api-3.0.0-RC3.pom --download-uri https://repo.maven.apache.org/maven2/jakarta/xml/bind/jakarta.xml.bind-api/3.0.0-RC3/jakarta.xml.bind-api-3.0.0-RC3-sources.jar --slot 0 --keywords "~amd64" --ebuild jakarta-xml-bind-api-3.0.0.ebuild
...
SRC_URI="https://repo.maven.apache.org/maven2/jakarta/xml/bind/jakarta.xml.bind-api/${PV}-RC3/jakarta.xml.bind-api-${PV}-RC3-sources.jar"
LICENSE=""
SLOT="0"
KEYWORDS="~amd64"
