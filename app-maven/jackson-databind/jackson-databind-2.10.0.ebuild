...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/jackson-databind-2.10.0.pom --download-uri https://repo1.maven.org/maven2/com/fasterxml/jackson/core/jackson-databind/2.10.0/jackson-databind-2.10.0-sources.jar --slot 0 --keywords "~amd64" --ebuild jackson-databind-2.10.0.ebuild
...
SRC_URI="https://repo1.maven.org/maven2/com/fasterxml/jackson/core/${PN}/${PV}/${P}-sources.jar -> ${P}.jar
