...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/hadoop-mapreduce-client-app-2.5.1.pom --download-uri https://repo.maven.apache.org/maven2/org/apache/hadoop/hadoop-mapreduce-client-app/2.5.1/hadoop-mapreduce-client-app-2.5.1-sources.jar --slot 0 --keywords "~amd64" --ebuild hadoop-mapreduce-client-app-2.5.1.ebuild
...
SLOT="0"
KEYWORDS="~amd64"
MAVEN_ID="org.apache.hadoop:hadoop-mapreduce-client-app:2.5.1"
...
# org.apache.hadoop:hadoop-mapreduce-client-shuffle:2.5.1 -> >=app-maven/hadoop-mapreduce-client-shuffle-2.5.1:0
# org.apache.hadoop:hadoop-yarn-server-web-proxy:2.5.1 -> >=app-maven/hadoop-yarn-server-web-proxy-2.5.1:0
...
CDEPEND="
	...
	>=app-maven/hadoop-mapreduce-client-common-2.5.1:0
	>=app-maven/hadoop-mapreduce-client-shuffle-2.5.1:0
	>=app-maven/hadoop-yarn-server-web-proxy-2.5.1:0
...
JAVA_GENTOO_CLASSPATH="guice-4,protobuf-java,netty,avro,hadoop-annotations,hadoop-mapreduce-client-common,hadoop-mapreduce-client-shuffle,hadoop-yarn-server-web-proxy,slf4j-ext,slf4j-ext"
