...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/jersey-server-2.29.1.pom --download-uri https://repo1.maven.org/maven2/org/glassfish/jersey/core/jersey-server/2.29.1/jersey-server-2.29.1-sources.jar --slot 0 --keywords "~amd64" --ebuild jersey-server-2.29.1.ebuild
...
JAVA_GENTOO_CLASSPATH="jakarta-annotation-api,jakarta-validation-api,ws-rs-api,jakarta-inject,jersey-client,jersey-common,jersey-media-jaxb"
