...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/jersey-server-1.9.pom --download-uri https://repo1.maven.org/maven2/com/sun/jersey/jersey-server/1.9/jersey-server-1.9-sources.jar --slot 0 --keywords "~amd64" --ebuild jersey-server-1.9.ebuild
...
# javax.servlet:javax.servlet-api:3.0.1 -> >=java-virtuals/servlet-api-4.0:4.0
