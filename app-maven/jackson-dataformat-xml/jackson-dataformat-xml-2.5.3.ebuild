...
# com.fasterxml.jackson.module:jackson-module-jaxb-annotations:2.5.3 -> >=app-maven/jackson-module-jaxb-annotations-2.5.3:0
# org.codehaus.woodstox:stax2-api:3.1.4 -> >=dev-java/stax2-api-4.0.0:0

CDEPEND="
	>=app-maven/jackson-module-jaxb-annotations-2.5.3:0
...
JAVA_GENTOO_CLASSPATH="jackson-annotations-2,jackson-2,jackson-databind-2,jackson-module-jaxb-annotations,stax2-api"
