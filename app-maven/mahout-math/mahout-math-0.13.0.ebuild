...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/mahout-math-0.13.0.pom --download-uri https://repo1.maven.org/maven2/org/apache/mahout/mahout-math/0.13.0/mahout-math-0.13.0-sources.jar --slot 0 --keywords "~amd64" --ebuild mahout-math-0.13.0.ebuild
...
SRC_URI="https://repo1.maven.org/maven2/org/apache/mahout/${PN}/${PV}/${P}-sources.jar -> ${P}.jar
