...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/hadoop-hdfs-2.5.1.pom --download-uri https://repo.maven.apache.org/maven2/org/apache/hadoop/hadoop-hdfs/2.5.1/hadoop-hdfs-2.5.1-sources.jar --slot 0 --keywords "~amd64" --ebuild hadoop-hdfs-2.5.1.ebuild
...
JAVA_GENTOO_CLASSPATH="guava,protobuf-java,jersey-core,jersey-server,commons-cli-1,commons-codec,commons-daemon,commons-io-1,commons-lang-2.1,commons-logging,netty,servlet-api-4.0,jsp-api-2.3,log4j,jackson-core-asl,jackson-mapper-asl,jetty,jetty-util,jasper-runtime,xmlenc"
