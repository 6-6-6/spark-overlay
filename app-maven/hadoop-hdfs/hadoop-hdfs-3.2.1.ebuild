...
# io.netty:netty-all:4.0.52.Final -> >=dev-java/netty-all-5.0.0:0
...
JAVA_GENTOO_CLASSPATH="jackson-databind-2,guava,protobuf-java,jersey-core,jersey-server,commons-cli-1,commons-codec,commons-daemon,commons-io,commons-logging,netty,netty-all,servlet-api-3.1,log4j,htrace-core4,jetty-server,jetty-util,jetty-util-ajax,leveldbjni-all"
JAVA_CLASSPATH_EXTRA="hadoop-annotations,hadoop-auth,hadoop-common,hadoop-hdfs-client,!!!suitble-avenVersion-not-found!!!"
