...
JAVA_GENTOO_CLASSPATH="guava,protobuf-java,jersey-core,jersey-server,commons-cli-1,commons-codec,commons-daemon,commons-io-1,commons-lang-2.1,commons-logging,netty,netty-all,servlet-4.0,log4j,htrace-core,jackson-core-asl,jackson-mapper-asl,leveldbjni-all,jetty-6,jetty-util-6,xerces-2,xmlenc"
