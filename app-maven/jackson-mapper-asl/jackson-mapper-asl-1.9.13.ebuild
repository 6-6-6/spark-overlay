...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/jackson-mapper-asl-1.9.13.pom --download-uri https://repo.maven.apache.org/maven2/org/codehaus/jackson/jackson-mapper-asl/1.9.13/jackson-mapper-asl-1.9.13-sources.jar --slot 0 --keywords "~amd64" --ebuild jackson-mapper-asl-1.9.13.ebuild
