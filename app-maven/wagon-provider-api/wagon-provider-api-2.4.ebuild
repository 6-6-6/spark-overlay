...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/wagon-provider-api-2.4.pom --download-uri https://repo1.maven.org/maven2/org/apache/maven/wagon/wagon-provider-api/2.4/wagon-provider-api-2.4-sources.jar --slot 0 --keywords "~amd64" --ebuild wagon-provider-api-2.4.ebuild
