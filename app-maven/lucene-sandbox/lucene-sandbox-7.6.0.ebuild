...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/lucene-sandbox-7.6.0.pom --download-uri https://repo.maven.apache.org/maven2/org/apache/lucene/lucene-sandbox/7.6.0/lucene-sandbox-7.6.0-sources.jar --slot 0 --keywords "~amd64" --ebuild lucene-sandbox-7.6.0.ebuild
