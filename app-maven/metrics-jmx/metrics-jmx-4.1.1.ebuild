...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/metrics-jmx-4.1.1.pom --download-uri https://repo.maven.apache.org/maven2/io/dropwizard/metrics/metrics-jmx/4.1.1/metrics-jmx-4.1.1-sources.jar --slot 0 --keywords "~amd64" --ebuild metrics-jmx-4.1.1.ebuild
