...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/asm-tree-5.0.3.pom --download-uri https://repo.maven.apache.org/maven2/org/ow2/asm/asm-tree/5.0.3/asm-tree-5.0.3-sources.jar --slot 0 --keywords "~amd64" --ebuild asm-tree-5.0.3.ebuild
...
SLOT="0"
KEYWORDS="~amd64"
MAVEN_ID="org.ow2.asm:asm-tree:5.0.3"
