...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/asm-commons-8.0.1.pom --download-uri https://repo.maven.apache.org/maven2/org/ow2/asm/asm-commons/8.0.1/asm-commons-8.0.1-sources.jar --slot 0 --keywords "~amd64" --ebuild asm-commons-8.0.1.ebuild
...
SLOT="0"
KEYWORDS="~amd64"
MAVEN_ID="org.ow2.asm:asm-commons:8.0.1"
