...
# joda-time:joda-time:2.10.1 -> >=dev-java/joda-time-2.10.6:0
...
JAVA_GENTOO_CLASSPATH="jackson-2,jackson-databind-2,zstd-jni,joda-time,commons-compress,slf4j-api,snappy-1.1"
JAVA_CLASSPATH_EXTRA="xz-java"
