...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/HdrHistogram-2.1.9.pom --download-uri https://repo1.maven.org/maven2/org/hdrhistogram/HdrHistogram/2.1.9/HdrHistogram-2.1.9-sources.jar --slot 0 --keywords "~amd64" --ebuild HdrHistogram-2.1.9.ebuild
