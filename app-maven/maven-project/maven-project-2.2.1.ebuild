...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/maven-project-2.2.1.pom --download-uri https://repo.maven.apache.org/maven2/org/apache/maven/maven-project/2.2.1/maven-project-2.2.1-sources.jar --slot 0 --keywords "~amd64" --ebuild maven-project-2.2.1.ebuild
