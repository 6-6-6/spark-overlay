...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/jersey-client-2.29.1.pom --download-uri https://repo1.maven.org/maven2/org/glassfish/jersey/core/jersey-client/2.29.1/jersey-client-2.29.1-sources.jar --slot 0 --keywords "~amd64" --ebuild jersey-client-2.29.1-r1.ebuild
...
JAVA_GENTOO_CLASSPATH="ws-rs,jakarta-inject,jersey-common"
