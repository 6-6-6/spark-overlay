...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/jboss-logging-annotations-2.1.0.Final.pom --download-uri https://repo.maven.apache.org/maven2/org/jboss/logging/jboss-logging-annotations/2.1.0.Final/jboss-logging-annotations-2.1.0.Final-sources.jar --slot 0 --keywords "~amd64" --ebuild jboss-logging-annotations-2.1.0.ebuild
