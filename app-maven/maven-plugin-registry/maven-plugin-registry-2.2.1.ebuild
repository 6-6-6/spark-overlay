...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/maven-plugin-registry-2.2.1.pom --download-uri https://repo1.maven.org/maven2/org/apache/maven/maven-plugin-registry/2.2.1/maven-plugin-registry-2.2.1-sources.jar --slot 0 --keywords "~amd64" --ebuild maven-plugin-registry-2.2.1.ebuild
