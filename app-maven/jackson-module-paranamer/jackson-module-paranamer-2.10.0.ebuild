...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/jackson-module-paranamer-2.10.0.pom --download-uri https://repo.maven.apache.org/maven2/com/fasterxml/jackson/module/jackson-module-paranamer/2.10.0/jackson-module-paranamer-2.10.0-sources.jar --slot 0 --keywords "~amd64" --ebuild jackson-module-paranamer-2.10.0.ebuild
