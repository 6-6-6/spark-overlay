...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/groovy-console-3.0.4.pom --download-uri https://repo.maven.apache.org/maven2/org/codehaus/groovy/groovy-console/3.0.4/groovy-console-3.0.4-sources.jar --slot 0 --keywords "~amd64" --ebuild groovy-console-3.0.4.ebuild
...
SLOT="0"
KEYWORDS="~amd64"
MAVEN_ID="org.codehaus.groovy:groovy-console:3.0.4"
...
JAVA_GENTOO_CLASSPATH="groovy,groovy-swing,groovy-templates"
