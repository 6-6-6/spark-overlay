...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/apacheds-i18n-2.0.0-M15.pom --download-uri https://repo.maven.apache.org/maven2/org/apache/directory/server/apacheds-i18n/2.0.0-M15/apacheds-i18n-2.0.0-M15-sources.jar --slot 0 --keywords "~amd64" --ebuild apacheds-i18n-2.0.0.ebuild
