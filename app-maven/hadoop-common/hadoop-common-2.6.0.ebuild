...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/hadoop-common-2.6.0.pom --download-uri https://repo.maven.apache.org/maven2/org/apache/hadoop/hadoop-common/2.6.0/hadoop-common-2.6.0-sources.jar --slot 0 --keywords "~amd64" --ebuild hadoop-common-2.6.0.ebuild
...
SLOT="0"
KEYWORDS="~amd64"
MAVEN_ID="org.apache.hadoop:hadoop-common:2.6.0"
...
# org.apache.curator:curator-client:2.6.0 -> >=app-maven/curator-client-2.6.0:0
# org.apache.curator:curator-recipes:2.6.0 -> >=app-maven/curator-recipes-2.6.0:0
...
CDEPEND="
	...
	>=app-maven/curator-client-2.6.0:0
	>=app-maven/curator-recipes-2.6.0:0
...
# tomcat:jasper-compiler:5.5.23 -> >=app-maven/jasper-compiler-5.5.23:0
# tomcat:jasper-runtime:5.5.23 -> >=app-maven/jasper-runtime-5.5.23:0
RDEPEND="
	>=virtual/jre-1.6:*
${CDEPEND}
	>=app-maven/jasper-compiler-5.5.23:0
