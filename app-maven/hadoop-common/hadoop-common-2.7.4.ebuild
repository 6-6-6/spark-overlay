...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/hadoop-common-2.7.4.pom --download-uri https://repo.maven.apache.org/maven2/org/apache/hadoop/hadoop-common/2.7.4/hadoop-common-2.7.4-sources.jar --slot 0 --keywords "~amd64" --ebuild hadoop-common-2.7.4.ebuild
...
CDEPEND="
	...
	>=app-maven/jetty-sslengine-6.1.26:0
