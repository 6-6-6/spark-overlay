...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/jul-to-slf4j-1.7.16.pom --download-uri https://repo1.maven.org/maven2/org/slf4j/jul-to-slf4j/1.7.16/jul-to-slf4j-1.7.16-sources.jar --slot 0 --keywords "~amd64" --ebuild jul-to-slf4j-1.7.16.ebuild
