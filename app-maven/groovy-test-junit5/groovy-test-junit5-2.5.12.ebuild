...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/groovy-test-junit5-2.5.12.pom --download-uri https://repo.maven.apache.org/maven2/org/codehaus/groovy/groovy-test-junit5/2.5.12/groovy-test-junit5-2.5.12-sources.jar --slot 0 --keywords "~amd64" --ebuild groovy-test-junit5-2.5.12.ebuild
...
SLOT="0"
KEYWORDS="~amd64"
MAVEN_ID="org.codehaus.groovy:groovy-test-junit5:2.5.12"
...
JAVA_GENTOO_CLASSPATH="groovy,junit-platform-launcher,junit-jupiter-engine"
