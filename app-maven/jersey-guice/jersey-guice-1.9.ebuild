...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/jersey-guice-1.9.pom --download-uri https://repo1.maven.org/maven2/com/sun/jersey/contribs/jersey-guice/1.9/jersey-guice-1.9-sources.jar --slot 0 --keywords "~amd64" --ebuild jersey-guice-1.9.ebuild
...
SRC_URI="https://repo1.maven.org/maven2/com/sun/jersey/contribs/${PN}/${PV}/${P}-sources.jar -> ${P}.jar
