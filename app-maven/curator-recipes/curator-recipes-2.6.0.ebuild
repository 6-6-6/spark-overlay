...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/curator-recipes-2.6.0.pom --download-uri https://repo.maven.apache.org/maven2/org/apache/curator/curator-recipes/2.6.0/curator-recipes-2.6.0-sources.jar --slot 0 --keywords "~amd64" --ebuild curator-recipes-2.6.0.ebuild
...
SLOT="0"
KEYWORDS="~amd64"
MAVEN_ID="org.apache.curator:curator-recipes:2.6.0"
