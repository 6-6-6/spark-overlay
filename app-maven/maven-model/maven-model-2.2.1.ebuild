...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/maven-model-2.2.1.pom --download-uri https://repo1.maven.org/maven2/org/apache/maven/maven-model/2.2.1/maven-model-2.2.1-sources.jar --slot 0 --keywords "~amd64" --ebuild maven-model-2.2.1.ebuild
