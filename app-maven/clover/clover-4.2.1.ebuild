...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/clover-4.2.1.pom --download-uri https://repo.maven.apache.org/maven2/org/openclover/clover/4.2.1/clover-4.2.1-sources.jar --slot 0 --keywords "~amd64" --ebuild clover-4.2.1.ebuild
...
SRC_URI="https://repo.maven.apache.org/maven2/org/open${PN}/${PN}/${PV}/${P}-sources.jar -> ${P}.jar"
LICENSE=""
SLOT="0"
KEYWORDS="~amd64"
