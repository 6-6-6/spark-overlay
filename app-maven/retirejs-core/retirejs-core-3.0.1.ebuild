...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/retirejs-core-3.0.1.pom --download-uri https://repo1.maven.org/maven2/com/h3xstream/retirejs/retirejs-core/3.0.1/retirejs-core-3.0.1-sources.jar --slot 0 --keywords "~amd64" --ebuild retirejs-core-3.0.1.ebuild
...
SRC_URI="https://repo1.maven.org/maven2/com/h3xstream/retirejs/${PN}/${PV}/${P}-sources.jar -> ${P}.jar
