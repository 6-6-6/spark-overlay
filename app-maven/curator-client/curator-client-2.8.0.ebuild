...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/curator-client-2.7.1.pom --download-uri https://repo1.maven.org/maven2/org/apache/curator/curator-client/2.7.1/curator-client-2.7.1-sources.jar --slot 0 --keywords "~amd64" --ebuild curator-client-2.7.1.ebuild
...
SLOT="0"
KEYWORDS="~amd64"
MAVEN_ID="org.apache.curator:curator-client:2.8.0"
