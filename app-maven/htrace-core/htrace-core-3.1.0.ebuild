...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/htrace-core-3.1.0-incubating.pom --download-uri https://repo1.maven.org/maven2/org/apache/htrace/htrace-core/3.1.0-incubating/htrace-core-3.1.0-incubating-sources.jar --slot 0 --keywords "~amd64" --ebuild htrace-core-3.1.0.ebuild
...
SRC_URI="https://repo1.maven.org/maven2/org/apache/htrace/${PN}/${PV}-incubating/${P}-incubating-sources.jar -> ${P}.jar
