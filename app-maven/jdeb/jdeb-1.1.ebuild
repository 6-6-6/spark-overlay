...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/jdeb-1.1.1.pom --download-uri https://repo1.maven.org/maven2/org/vafer/jdeb/1.1.1/jdeb-1.1.1-sources.jar --slot 0 --keywords "~amd64" --ebuild jdeb-1.1.1.ebuild
...
SRC_URI="https://repo1.maven.org/maven2/org/vafer/${PN}/${PV}/${P}-sources.jar -> ${P}.jar
	https://repo1.maven.org/maven2/org/vafer/${PN}/${PV}/${P}.jar -> ${P}-bin.jar"
LICENSE=""
SLOT="0"
KEYWORDS="~amd64"
MAVEN_ID="org.vafer:jdeb:1.1"
...
src_unpack() {
	...
	eapply ${FILESDIR}/${P}-fix-bcpg.patch || die
}
