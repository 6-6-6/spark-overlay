...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/api-asn1-api-1.0.0-M20.pom --download-uri https://repo.maven.apache.org/maven2/org/apache/directory/api/api-asn1-api/1.0.0-M20/api-asn1-api-1.0.0-M20-sources.jar --slot 0 --keywords "~amd64" --ebuild api-asn1-api-1.0.0.ebuild
