...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/mail-1.4.pom --download-uri https://repo1.maven.org/maven2/javax/mail/mail/1.4/mail-1.4-sources.jar --slot 0 --keywords "~amd64" --ebuild mail-1.4.ebuild
