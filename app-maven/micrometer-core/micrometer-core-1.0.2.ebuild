...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/micrometer-core-1.0.2.pom --download-uri https://repo.maven.apache.org/maven2/io/micrometer/micrometer-core/1.0.2/micrometer-core-1.0.2-sources.jar --slot 0 --keywords "~amd64" --ebuild micrometer-core-1.0.2.ebuild
...
# com.squareup.okhttp3:okhttp:3.9.1 -> >=app-maven/okhttp-4.7.2:0
