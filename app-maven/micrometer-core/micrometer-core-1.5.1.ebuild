...
# com.google.guava:guava:29.0-jre -> >=dev-java/guava-20.0:20
...
# net.sf.ehcache:ehcache:2.10.6 -> >=dev-java/ehcache-1.2.4:1.2
# org.apache.httpcomponents:httpasyncclient:4.1.4 -> >=app-maven/httpasyncclient-4.1.4:0
# org.apache.httpcomponents:httpclient:4.5.12 -> >=dev-java/httpcomponents-client-4.5:4.5
...
# org.aspectj:aspectjweaver:1.8.14 -> >=dev-java/aspectj-1.7.4:0
# org.eclipse.jetty:jetty-client:9.4.28.v20200408 -> >=app-maven/jetty-client-9.4.28_p20200408:0
# org.eclipse.jetty:jetty-server:9.4.28.v20200408 -> >=app-maven/jetty-server-9.3.24_p20180605:0
...
CDEPEND="
	...
	>=dev-java/aspectj-1.7.4:0
	>=dev-java/ehcache-1.2.4:1.2
...
JAVA_GENTOO_CLASSPATH="logback-classic,caffeine,jsr305,guava-20,hazelcast,hystrix-core,okhttp,metrics-core,reactor-core,reactor-netty,cache-api,ehcache-1.2,httpasyncclient,httpcomponents-client-4.5,kafka-clients,kafka-streams,log4j-core,tomcat-embed-core,aspectj,jetty-client,jetty-server,HdrHistogram,hibernate-core,jooq,mongo-java-driver,LatencyUtils"
