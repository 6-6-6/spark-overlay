...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/weld-core-1.1.0.Final.pom --download-uri https://repo1.maven.org/maven2/org/jboss/weld/weld-core/1.1.0.Final/weld-core-1.1.0.Final-sources.jar --slot 0 --keywords "~amd64" --ebuild weld-core-1.1.0.ebuild
