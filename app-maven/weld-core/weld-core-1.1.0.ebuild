...
# ch.qos.cal10n:cal10n-api:0.7.2 -> >=app-maven/cal10n-api-0.7.2:0
...
# org.slf4j:slf4j-api:1.5.10 -> >=dev-java/slf4j-ext-1.7.5:0
# org.slf4j:slf4j-ext:1.5.10 -> >=dev-java/slf4j-ext-1.7.5:0

CDEPEND="
	>=app-maven/cal10n-api-0.7.2:0
...
JAVA_GENTOO_CLASSPATH="cal10n-api,guava-${PV%.*},jsr250,el-api-3.0,cdi-api-1.2,jsf-api,persistence-api,servlet-api-2.5,jsp-api-2.3,jta,validation-api-1.0,findbugs-annotation-3,javassist-3,jboss-interceptor-core,jboss-interceptor-spi,jboss-ejb-api-3.1_spec,jboss-interceptors-api-1.1_spec,weld-api,weld-spi,slf4j-ext,slf4j-ext"
