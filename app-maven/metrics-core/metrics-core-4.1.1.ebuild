...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/metrics-core-4.1.1.pom --download-uri https://repo.maven.apache.org/maven2/io/dropwizard/metrics/metrics-core/4.1.1/metrics-core-4.1.1-sources.jar --slot 0 --keywords "~amd64" --ebuild metrics-core-4.1.1.ebuild
