...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/hadoop-yarn-server-web-proxy-2.7.4.pom --download-uri https://repo.maven.apache.org/maven2/org/apache/hadoop/hadoop-yarn-server-web-proxy/2.7.4/hadoop-yarn-server-web-proxy-2.7.4-sources.jar --slot 0 --keywords "~amd64" --ebuild hadoop-yarn-server-web-proxy-2.7.4.ebuild
...
SLOT="0"
KEYWORDS="~amd64"
MAVEN_ID="org.apache.hadoop:hadoop-yarn-server-web-proxy:2.7.4"
