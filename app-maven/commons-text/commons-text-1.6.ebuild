...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/commons-text-1.6.pom --download-uri https://repo1.maven.org/maven2/org/apache/commons/commons-text/1.6/commons-text-1.6-sources.jar --slot 0 --keywords "~amd64" --ebuild commons-text-1.6.ebuild
