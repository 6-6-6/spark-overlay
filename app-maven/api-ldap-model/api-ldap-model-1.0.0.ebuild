...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/api-ldap-model-1.0.0-M20.pom --download-uri https://repo1.maven.org/maven2/org/apache/directory/api/api-ldap-model/1.0.0-M20/api-ldap-model-1.0.0-M20-sources.jar --slot 0 --keywords "~amd64" --ebuild api-ldap-model-1.0.0.ebuild
