...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/asm-analysis-3.3.1.pom --download-uri https://repo.maven.apache.org/maven2/asm/asm-analysis/3.3.1/asm-analysis-3.3.1.jar --slot 0 --keywords "~amd64" --ebuild asm-analysis-3.3.1.ebuild
...
SLOT="0"
KEYWORDS="~amd64"
MAVEN_ID="asm:asm-analysis:3.3.1"
