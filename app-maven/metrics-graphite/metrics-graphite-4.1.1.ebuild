...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/metrics-graphite-4.1.1.pom --download-uri https://repo.maven.apache.org/maven2/io/dropwizard/metrics/metrics-graphite/4.1.1/metrics-graphite-4.1.1-sources.jar --slot 0 --keywords "~amd64" --ebuild metrics-graphite-4.1.1.ebuild
