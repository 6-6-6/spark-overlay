...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/jasper-compiler-5.5.23.pom --download-uri https://repo.maven.apache.org/maven2/tomcat/jasper-compiler/5.5.23/jasper-compiler-5.5.23.jar --slot 0 --keywords "~amd64" --ebuild jasper-compiler-5.5.23.ebuild
