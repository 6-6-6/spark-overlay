...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/jersey-container-servlet-core-2.29.1.pom --download-uri https://repo1.maven.org/maven2/org/glassfish/jersey/containers/jersey-container-servlet-core/2.29.1/jersey-container-servlet-core-2.29.1-sources.jar --slot 0 --keywords "~amd64" --ebuild jersey-container-servlet-core-2.29.1.ebuild
...
# POM: /var/lib/java-ebuilder/poms/${P}.pom
# jakarta.persistence:jakarta.persistence-api:2.2.3 -> >=app-maven/jakarta-persistence-api-2.2.3:0
...
DEPEND="
	...
	!binary? (
	${CDEPEND}
	>=app-maven/jakarta-persistence-api-2.2.3:0
...
JAVA_GENTOO_CLASSPATH="ws-rs-api,jakarta-inject,jersey-common,jersey-server"
