...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/woodstox-core-asl-4.3.0.pom --download-uri https://repo1.maven.org/maven2/org/codehaus/woodstox/woodstox-core-asl/4.3.0/woodstox-core-asl-4.3.0-sources.jar --slot 0 --keywords "~amd64" --ebuild woodstox-core-asl-4.3.0.ebuild
...
SRC_URI="https://repo1.maven.org/maven2/org/codehaus/woodstox/${PN}/${PV}/${P}-sources.jar -> ${P}.jar
