...
# javax.annotation:javax.annotation-api:1.3.2 -> >=dev-java/jsr250-1.2:0
...
# POM: /var/lib/java-ebuilder/poms/${P}.pom
# javax.servlet:javax.servlet-api:4.0.1 -> >=java-virtuals/servlet-api-2.3:2.3
...
JAVA_GENTOO_CLASSPATH="jackson-2,jackson-databind,zstd-jni,jsr250,avro,velocity-engine-core,slf4j-api,snappy-1.0"
