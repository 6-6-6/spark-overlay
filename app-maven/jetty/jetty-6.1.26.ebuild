...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/jetty-6.1.26.pom --download-uri https://repo1.maven.org/maven2/org/mortbay/jetty/jetty/6.1.26/jetty-6.1.26-sources.jar --slot 6 --keywords "~amd64" --ebuild jetty-6.1.26.ebuild
...
SRC_URI="https://repo1.maven.org/maven2/org/mortbay/${PN}/${PN}/${PV}/${P}-sources.jar -> ${P}.jar
