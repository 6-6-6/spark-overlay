...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/dependency-check-core-4.0.2.pom --download-uri https://repo1.maven.org/maven2/org/owasp/dependency-check-core/4.0.2/dependency-check-core-4.0.2-sources.jar --slot 0 --keywords "~amd64" --ebuild dependency-check-core-4.0.2.ebuild
...
SRC_URI="https://repo1.maven.org/maven2/org/owasp/${PN}/${PV}/${P}-sources.jar -> ${P}.jar
...
# com.sun.mail:mailapi:1.6.3 -> >=app-maven/mailapi-1.6.3:0
