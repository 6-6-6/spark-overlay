...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/hibernate-core-5.2.13.Final.pom --download-uri https://repo.maven.apache.org/maven2/org/hibernate/hibernate-core/5.2.13.Final/hibernate-core-5.2.13.Final-sources.jar --slot 0 --keywords "~amd64" --ebuild hibernate-core-5.2.13.ebuild
...
SRC_URI="https://repo.maven.apache.org/maven2/org/hibernate/${PN}/${PV}.Final/${P}.Final-sources.jar -> ${P}.jar"
LICENSE=""
SLOT="0"
KEYWORDS="~amd64"
...
# com.fasterxml:classmate:1.3.0 -> >=dev-java/classmate-1.3.0:0
...
# org.jboss.logging:jboss-logging:3.3.1.Final -> >=dev-java/jboss-logging-3.3.1:0
...
CDEPEND="
	...
	>=dev-java/classmate-1.3.0:0
	>=dev-java/dom4j-1.6.1:1
	>=dev-java/javassist-3.21.0:3
	>=dev-java/jboss-logging-3.3.1:0
"
...
JAVA_GENTOO_CLASSPATH="antlr,classmate,dom4j-1,hibernate-commons-annotations,hibernate-jpa-2.1-api,javassist-3,jandex,jboss-logging,jboss-transaction-api-1.2_spec"
