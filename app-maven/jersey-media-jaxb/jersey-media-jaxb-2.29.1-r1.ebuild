...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/jersey-media-jaxb-2.29.1.pom --download-uri https://repo1.maven.org/maven2/org/glassfish/jersey/media/jersey-media-jaxb/2.29.1/jersey-media-jaxb-2.29.1-sources.jar --slot 0 --keywords "~amd64" --ebuild jersey-media-jaxb-2.29.1-r1.ebuild
