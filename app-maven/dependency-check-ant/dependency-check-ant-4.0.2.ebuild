...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/dependency-check-ant-4.0.2.pom --download-uri https://repo1.maven.org/maven2/org/owasp/dependency-check-ant/4.0.2/dependency-check-ant-4.0.2-sources.jar --slot 0 --keywords "~amd64" --ebuild dependency-check-ant-4.0.2.ebuild
