...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/jetty-http-9.4.8.v20171121.pom --download-uri https://repo1.maven.org/maven2/org/eclipse/jetty/jetty-http/9.4.8.v20171121/jetty-http-9.4.8.v20171121-sources.jar --slot 9 --keywords "~amd64" --ebuild jetty-http-9.4.8_p20171121-r1.ebuild
...
# org.eclipse.jetty:jetty-util:9.4.8.v20171121 -> >=app-maven/jetty-util-9.4.8_p20171121:9

CDEPEND="
	>=app-maven/jetty-io-9.4.8_p20171121:9
	>=app-maven/jetty-util-9.4.8_p20171121:9
"
