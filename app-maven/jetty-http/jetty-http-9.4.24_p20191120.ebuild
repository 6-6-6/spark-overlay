...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/jetty-http-9.4.24.v20191120.pom --download-uri https://repo.maven.apache.org/maven2/org/eclipse/jetty/jetty-http/9.4.24.v20191120/jetty-http-9.4.24.v20191120-sources.jar --slot 0 --keywords "~amd64" --ebuild jetty-http-9.4.24_p20191120.ebuild
...
SLOT="0"
KEYWORDS="~amd64"
MAVEN_ID="org.eclipse.jetty:jetty-http:9.4.24.v20191120"
