...
# com.fasterxml:classmate:1.3.4 -> >=dev-java/classmate-0.9.0:0
...
# joda-time:joda-time:2.9.7 -> >=dev-java/joda-time-2.7:0
# org.jboss.logging:jboss-logging:3.3.2.Final -> >=dev-java/jboss-logging-3.1.4:0
...
JAVA_GENTOO_CLASSPATH_EXTRA="jakarta-el,jboss-logging-annotations,jboss-logging-processor"
