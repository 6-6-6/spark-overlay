...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/compress-lzf-1.0.3.pom --download-uri https://repo.maven.apache.org/maven2/com/ning/compress-lzf/1.0.3/compress-lzf-1.0.3-sources.jar --slot 0 --keywords "~amd64" --ebuild compress-lzf-1.0.3.ebuild
