...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/json4s-scalap_2.12-3.6.6.pom --download-uri https://repo.maven.apache.org/maven2/org/json4s/json4s-scalap_2.12/3.6.6/json4s-scalap_2.12-3.6.6-sources.jar --slot 2.12 --keywords "~amd64" --ebuild json4s-scalap-3.6.6.ebuild
