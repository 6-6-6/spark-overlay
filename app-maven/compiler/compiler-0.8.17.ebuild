...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/compiler-0.8.17.pom --download-uri https://repo1.maven.org/maven2/com/github/spullara/mustache/java/compiler/0.8.17/compiler-0.8.17-sources.jar --slot 0 --keywords "~amd64" --ebuild compiler-0.8.17.ebuild
...
SRC_URI="https://repo1.maven.org/maven2/com/github/spullara/mustache/java/${PN}/${PV}/${P}-sources.jar -> ${P}.jar
