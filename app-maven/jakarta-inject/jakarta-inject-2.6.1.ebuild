...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/jakarta.inject-2.6.1.pom --download-uri https://repo1.maven.org/maven2/org/glassfish/hk2/external/jakarta.inject/2.6.1/jakarta.inject-2.6.1-sources.jar --slot 0 --keywords "~amd64" --ebuild jakarta-inject-2.6.1.ebuild
...
SRC_URI="https://repo1.maven.org/maven2/org/glassfish/hk2/external/jakarta.inject/${PV}/jakarta.inject-${PV}-sources.jar -> ${P}.jar
