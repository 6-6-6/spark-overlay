...
SRC_URI="https://repo1.maven.org/maven2/org/jboss/spec/javax/transaction/${PN}_1.2_spec/${PV}.Final/${PN}_1.2_spec-${PV}.Final-sources.jar -> ${P}.jar
...
# org.jboss.spec.javax.interceptor:jboss-interceptors-api_1.2_spec:1.0.0.Final -> >=app-maven/jboss-interceptors-api-1.0.1:1.2_spec

DEPEND="
	>=virtual/jdk-1.7:*
	app-arch/unzip
	!binary? (
	>=app-maven/jboss-interceptors-api-1.0.1:1.2_spec
