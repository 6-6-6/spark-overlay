...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/py4j-0.10.8.1.pom --download-uri https://repo.maven.apache.org/maven2/net/sf/py4j/py4j/0.10.8.1/py4j-0.10.8.1-sources.jar --slot 0 --keywords "~amd64" --ebuild py4j-0.10.8.1.ebuild
