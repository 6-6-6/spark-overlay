...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/jsr292-mock-1.1.pom --download-uri https://repo1.maven.org/maven2/com/headius/jsr292-mock/1.1/jsr292-mock-1.1-sources.jar --slot 0 --keywords "~amd64" --ebuild jsr292-mock-1.1.ebuild
