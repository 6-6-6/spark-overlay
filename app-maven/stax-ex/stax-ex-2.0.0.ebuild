...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/stax-ex-2.0.0-M2.pom --download-uri https://repo.maven.apache.org/maven2/org/jvnet/staxex/stax-ex/2.0.0-M2/stax-ex-2.0.0-M2-sources.jar --slot 0 --keywords "~amd64" --ebuild stax-ex-2.0.0.ebuild
...
SRC_URI="https://repo.maven.apache.org/maven2/org/jvnet/staxex/${PN}/${PV}-M2/${P}-M2-sources.jar"
LICENSE=""
SLOT="0"
KEYWORDS="~amd64"
