...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/log4j-core-2.3.pom --download-uri https://repo1.maven.org/maven2/org/apache/logging/log4j/log4j-core/2.3/log4j-core-2.3-sources.jar --slot 0 --keywords "~amd64" --ebuild log4j-core-2.3.ebuild
...
SRC_URI="https://repo1.maven.org/maven2/org/apache/logging/log4j/${PN}/${PV}/${P}-sources.jar -> ${P}.jar
...
# com.sun.mail:javax.mail:1.5.2 -> >=app-maven/javax-mail-1.5.2:0
