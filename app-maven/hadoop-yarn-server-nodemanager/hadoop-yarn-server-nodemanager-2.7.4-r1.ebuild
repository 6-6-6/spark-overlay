...
JAVA_GENTOO_CLASSPATH="guava,guice-4,guice-4,protobuf-java,jersey-client,jersey-core,jersey-json,jersey-guice,commons-codec,commons-lang-2.1,commons-logging,servlet-4.0,jaxb-api,hadoop-annotations,hadoop-yarn-api,hadoop-yarn-common,hadoop-yarn-server-common,jettison,leveldbjni-all,jetty-util-6,slf4j-api"
