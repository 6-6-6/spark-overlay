...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/maven-artifact-3.0.pom --download-uri https://repo1.maven.org/maven2/org/apache/maven/maven-artifact/3.0/maven-artifact-3.0-sources.jar --slot 0 --keywords "~amd64" --ebuild maven-artifact-3.0.ebuild
...
# org.codehaus.plexus:plexus-utils:2.0.4 -> >=app-maven/plexus-utils-3.0.8:0
