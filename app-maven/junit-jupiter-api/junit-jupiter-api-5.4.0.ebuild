...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/junit-jupiter-api-5.4.0.pom --download-uri https://repo.maven.apache.org/maven2/org/junit/jupiter/junit-jupiter-api/5.4.0/junit-jupiter-api-5.4.0-sources.jar --slot 0 --keywords "~amd64" --ebuild junit-jupiter-api-5.4.0.ebuild
...
SLOT="0"
KEYWORDS="~amd64"
MAVEN_ID="org.junit.jupiter:junit-jupiter-api:5.4.0"
