...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/hadoop-auth-2.6.0.pom --download-uri https://repo.maven.apache.org/maven2/org/apache/hadoop/hadoop-auth/2.6.0/hadoop-auth-2.6.0-sources.jar --slot 0 --keywords "~amd64" --ebuild hadoop-auth-2.6.0.ebuild
...
SLOT="0"
KEYWORDS="~amd64"
MAVEN_ID="org.apache.hadoop:hadoop-auth:2.6.0"

# Common dependencies
# POM: /var/lib/java-ebuilder/poms/${P}.pom
# commons-codec:commons-codec:1.4 -> >=dev-java/commons-codec-1.7:0
# org.apache.curator:curator-framework:2.6.0 -> >=app-maven/curator-framework-2.6.0:0
...
CDEPEND="
	...
	>=app-maven/curator-framework-2.6.0:0
...
JAVA_GENTOO_CLASSPATH="commons-codec,curator-framework,apacheds-kerberos-codec,httpcomponents-client-4.5,zookeeper,slf4j-ext,log4j,slf4j-ext"
