...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/jersey-media-sse-2.29.1.pom --download-uri https://repo1.maven.org/maven2/org/glassfish/jersey/media/jersey-media-sse/2.29.1/jersey-media-sse-2.29.1-sources.jar --slot 0 --keywords "~amd64" --ebuild jersey-media-sse-2.29.1.ebuild
