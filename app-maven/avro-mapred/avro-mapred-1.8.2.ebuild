...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/avro-mapred-1.8.2.pom --download-uri https://repo1.maven.org/maven2/org/apache/avro/avro-mapred/1.8.2/avro-mapred-1.8.2-sources.jar --slot 0 --keywords "~amd64" --ebuild avro-mapred-1.8.2.ebuild
