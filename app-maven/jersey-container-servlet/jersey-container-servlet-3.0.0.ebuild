...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/jersey-container-servlet-3.0.0-M1.pom --download-uri https://repo.maven.apache.org/maven2/org/glassfish/jersey/containers/jersey-container-servlet/3.0.0-M1/jersey-container-servlet-3.0.0-M1-sources.jar --slot 0 --keywords "~amd64" --ebuild jersey-container-servlet-3.0.0.ebuild
...
SLOT="0"
KEYWORDS="~amd64"
MAVEN_ID="org.glassfish.jersey.containers:jersey-container-servlet:3.0.0-M1"

# Common dependencies
# POM: /var/lib/java-ebuilder/poms/${P}-M1.pom
# jakarta.ws.rs:jakarta.ws.rs-api:3.0.0-M1 -> >=app-maven/jakarta-ws-rs-api-3.0.0:0
# org.glassfish.jersey.containers:jersey-container-servlet-core:3.0.0-M1 -> >=app-maven/jersey-container-servlet-core-3.0.0:0
