...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/ehcache-core-2.4.4.pom --download-uri https://repo1.maven.org/maven2/net/sf/ehcache/ehcache-core/2.4.4/ehcache-core-2.4.4-sources.jar --slot 0 --keywords "~amd64" --ebuild ehcache-core-2.4.4.ebuild
...
SRC_URI="https://repo1.maven.org/maven2/net/sf/ehcache/${PN}/${PV}/${P}-sources.jar -> ${P}.jar
