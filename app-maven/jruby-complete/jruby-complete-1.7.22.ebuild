...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/jruby-complete-1.7.22.pom --download-uri https://repo.maven.apache.org/maven2/org/jruby/jruby-complete/1.7.22/jruby-complete-1.7.22-sources.jar --slot 0 --keywords "~amd64" --ebuild jruby-complete-1.7.22.ebuild
