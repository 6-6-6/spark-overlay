...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/jersey-common-2.29.1.pom --download-uri https://repo.maven.apache.org/maven2/org/glassfish/jersey/core/jersey-common/2.29.1/jersey-common-2.29.1-sources.jar --slot 0 --keywords "~amd64" --ebuild jersey-common-2.29.1.ebuild
...
JAVA_GENTOO_CLASSPATH="jakarta-annotation-api,jakarta-ws-rs-api,osgi-resource-locator,jakarta-inject"
