...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/hadoop-mapreduce-client-shuffle-2.7.4.pom --download-uri https://repo.maven.apache.org/maven2/org/apache/hadoop/hadoop-mapreduce-client-shuffle/2.7.4/hadoop-mapreduce-client-shuffle-2.7.4-sources.jar --slot 0 --keywords "~amd64" --ebuild hadoop-mapreduce-client-shuffle-2.7.4.ebuild
...
# org.apache.hadoop:hadoop-yarn-server-nodemanager:2.7.4 -> >=app-maven/hadoop-yarn-server-nodemanager-2.7.4:0
...
CDEPEND="
	...
	>=app-maven/hadoop-yarn-server-nodemanager-2.7.4:0
