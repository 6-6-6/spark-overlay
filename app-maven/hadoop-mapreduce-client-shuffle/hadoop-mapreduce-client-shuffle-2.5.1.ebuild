...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/hadoop-mapreduce-client-shuffle-2.5.1.pom --download-uri https://repo.maven.apache.org/maven2/org/apache/hadoop/hadoop-mapreduce-client-shuffle/2.5.1/hadoop-mapreduce-client-shuffle-2.5.1-sources.jar --slot 0 --keywords "~amd64" --ebuild hadoop-mapreduce-client-shuffle-2.5.1.ebuild
...
SLOT="0"
KEYWORDS="~amd64"
MAVEN_ID="org.apache.hadoop:hadoop-mapreduce-client-shuffle:2.5.1"
...
JAVA_GENTOO_CLASSPATH="guice-4,protobuf-java,netty,avro,hadoop-annotations,hadoop-mapreduce-client-common,hadoop-yarn-server-common,hadoop-yarn-server-nodemanager,leveldbjni-all,slf4j-ext,slf4j-ext"
