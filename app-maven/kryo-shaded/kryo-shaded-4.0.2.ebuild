...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/kryo-shaded-4.0.2.pom --download-uri https://repo1.maven.org/maven2/com/esotericsoftware/kryo-shaded/4.0.2/kryo-shaded-4.0.2-sources.jar --slot 0 --keywords "~amd64" --ebuild kryo-shaded-4.0.2.ebuild
...
SRC_URI="https://repo1.maven.org/maven2/com/esotericsoftware/${PN}/${PV}/${P}-sources.jar -> ${P}.jar
