...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/byte-buddy-1.6.14.pom --download-uri https://repo1.maven.org/maven2/net/bytebuddy/byte-buddy/1.6.14/byte-buddy-1.6.14-sources.jar --slot 0 --keywords "~amd64" --ebuild byte-buddy-1.6.14.ebuild
...
SRC_URI="https://repo1.maven.org/maven2/net/bytebuddy/${PN}/${PV}/${P}-sources.jar -> ${P}.jar
