...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/cache-api-1.0.0.pom --download-uri https://repo.maven.apache.org/maven2/javax/cache/cache-api/1.0.0/cache-api-1.0.0-sources.jar --slot 0 --keywords "~amd64" --ebuild cache-api-1.0.0.ebuild
