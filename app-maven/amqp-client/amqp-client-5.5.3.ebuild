...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/amqp-client-5.5.3.pom --download-uri https://repo.maven.apache.org/maven2/com/rabbitmq/amqp-client/5.5.3/amqp-client-5.5.3-sources.jar --slot 0 --keywords "~amd64" --ebuild amqp-client-5.5.3.ebuild
