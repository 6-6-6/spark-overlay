...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/RoaringBitmap-0.7.45.pom --download-uri https://repo1.maven.org/maven2/org/roaringbitmap/RoaringBitmap/0.7.45/RoaringBitmap-0.7.45-sources.jar --slot 0 --keywords "~amd64" --ebuild RoaringBitmap-0.7.45.ebuild
