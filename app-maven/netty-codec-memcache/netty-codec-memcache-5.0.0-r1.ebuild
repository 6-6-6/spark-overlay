...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/netty-codec-memcache-5.0.0.Alpha2.pom --download-uri https://repo1.maven.org/maven2/io/netty/netty-codec-memcache/5.0.0.Alpha2/netty-codec-memcache-5.0.0.Alpha2-sources.jar --slot 0 --keywords "~amd64" --ebuild netty-codec-memcache-5.0.0-r1.ebuild
