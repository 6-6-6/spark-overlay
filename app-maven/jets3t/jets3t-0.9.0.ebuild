...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/jets3t-0.9.0.pom --download-uri https://repo1.maven.org/maven2/net/java/dev/jets3t/jets3t/0.9.0/jets3t-0.9.0-sources.jar --slot 0 --keywords "~amd64" --ebuild jets3t-0.9.0.ebuild
