...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/gpars-1.0.0.pom --download-uri https://repo1.maven.org/maven2/org/codehaus/gpars/gpars/1.0.0/gpars-1.0.0-sources.jar --slot 0 --keywords "~amd64" --ebuild gpars-1.0.0.ebuild
