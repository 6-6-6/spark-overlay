...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/weld-ejb-4.0.0.Alpha2.pom --download-uri https://repo.maven.apache.org/maven2/org/jboss/weld/module/weld-ejb/4.0.0.Alpha2/weld-ejb-4.0.0.Alpha2-sources.jar --slot 0 --keywords "~amd64" --ebuild weld-ejb-4.0.0.ebuild
...
SLOT="0"
KEYWORDS="~amd64"
MAVEN_ID="org.jboss.weld.module:weld-ejb:4.0.0.Alpha2"
...
JAVA_GENTOO_CLASSPATH="spotbugs-annotations,jakarta-ejb-api,jakarta-enterprise-cdi-api,jakarta-transaction-api,weld-api,weld-core-impl,weld-spi"
