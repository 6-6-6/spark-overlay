...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /var/lib/java-ebuilder/poms/weld-spi-1.1.Final.pom --download-uri https://repo1.maven.org/maven2/org/jboss/weld/weld-spi/1.1.Final/weld-spi-1.1.Final-sources.jar --slot 0 --keywords "~amd64" --ebuild weld-spi-1.1.ebuild
